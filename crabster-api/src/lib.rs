...
pub struct ApiState {
    ...
    pub db: Option<crabster_db::Database>,
    pub jwt_secret: String,
    pub analytics: Option<std::sync::Arc<crabster_analytics::AnalyticsCollector>>,
    pub health: Option<Arc<crabster_health::checker::HealthChecker>>,
    pub hls: Option<Arc<crabster_hls::HlsManager>>,
}
