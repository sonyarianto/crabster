...
impl EdgeNode {
    ...
    pub async fn start(&self, config: &ClusterConfig, core: crabster_core::SharedState) {
                        ...
                        Ok(mut stream) => {
                            let request = format!(
                                "GET {} HTTP/1.0\r\n\
                                 Host: {}:{}\r\n\
                                 icy-relay: 1\r\n\
                                 User-Agent: Crabster-Edge/0.1.0\r\n\
                                 \r\n",
                            ...
                            let info = Arc::new(SourceInfo {
                                ...
                                user_agent: "Crabster-Edge/0.1.0".into(),
                                format: crabster_core::format::FormatType::from_content_type(
